...
import com.rickey.backend.model.dto.userinterfaceinfo.UserInterfaceInfoAddRequest;
import com.rickey.backend.model.dto.userinterfaceinfo.UserInterfaceInfoQueryRequest;
import com.rickey.backend.model.dto.userinterfaceinfo.UserInterfaceInfoUpdateRequest;
...
public class UserInterfaceInfoController {
    ...
    public BaseResponse<Boolean> deleteUserInterfaceInfo(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        // 仅本人或管理员可删除
        if (!oldUserInterfaceInfo.getUserId().equals(userId) && !userService.isAdmin(request)) {
